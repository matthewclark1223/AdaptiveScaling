functions {
  ...
  real[] SI(real t,
      ...
      real dydt[4];   #params[1] = beta, params[2] = epsilon, params[3] = alpha
      
      dydt[1] = - params[1] * y[1] * y[3] - params[3]*y[1];
      dydt[2] = params[1] * y[1] * y[3]- params[2] * y[2];
      dydt[3] = params[2] * y[2] + params[3]*y[1];
      dydt[4] = 0;
...
model {
  params ~ normal(0, 0.4); //constrained to be positive
  S0 ~ normal(0.5, 0.3); //constrained to be 0-1.
  M0 ~ normal(0.5, 0.3); //constrained to be 0-1.
