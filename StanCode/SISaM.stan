...
model {
  params[1] ~ normal(0, 0.25); //constrained to be positive   best is 0.0
  params[2] ~ normal(0, 0.05); //constrained to be positive
  params[3] ~ normal(0, 0.25); //constrained to be positive
  S0 ~ normal(0.5, 0.1); //constrained to be 0-1.(0.5,0.5)
  M0 ~ normal(0.5, 0.1); //constrained to be 0-1. (0.5,0.5)
